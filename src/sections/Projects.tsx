  ...
  return (
    <section className="pb-16 lg:py-24 ">
      <div className="container">
        ...
        <h2 className="font-serif text-3xl md:text-5xl lg: text-xl text-center mt-6">
          Featured Projects
        </h2>
        <p className="text-center md:text-lg  text-white/60 mt-4 max-w-md mx-auto ">
          See how I transformed concepts into enaging digital experiences.
        </p>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                ...
                <div className="relative">
                  <Image
                    src={project.image}
                    alt={project.title}
                    className="mt-8 -mb-4 md:-mb-0 lg:mt-0  lg:mt-0 lg:absolute lg:h-full lg:w-auto lg:max-w-none"
                  />
                </div>
              </div>
            </div>
